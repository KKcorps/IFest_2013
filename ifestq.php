...
var a3="Statements being put up!";
...
<div id="home_wrapper">
<a href="edit_profile.php"><div id="usrnm"><?php if(isset($_SESSION['username'])) echo "Welcome ".$_SESSION['username']; ?></div></a>
		...
		<div>
			...
			<div id="cruxbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
                    ...
                    <a data-toggle="modal" href="#rcrux" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#pcrux" class="btn btn-primary btn-lg">Prizes</a>


						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Let the world know you are out on a quest! A quest for the lost treasure! iFest 2013 brings you all new season of treasure hunting in Crux 3.0. This game is designed to test your creativity, resourcefulness and appetite for winning. Here you have only one golden rule: 'solve the maximum number of puzzles, no matter how'. Remember, everything is fair in love, war and Crux 3.0!
			...
			<div id="envibbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
                    ...
                    <a data-toggle="modal" href="#renv" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#penv" class="btn btn-primary btn-lg">Prizes</a>


						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>
			...
			<div id="logibbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>LOGICODE</p></div>
                      ...
                      <a data-toggle="modal" href="#rlogi" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#plogi" class="btn btn-primary btn-lg">Prizes</a>


						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Was #include<'meinthisworld'> the first word that came out of your mouth after birth?  Do you prefer counting in binary than in decimal? Do you dream coding? Then, sleep will be on standby as your system will experience the tremors of Logicode when the coding wizards will tear apart mathematical, scientific and technical problems in a furious battle of wits against the best brains across the world. The contest will test the programming skills and problem-solving capabilities of the participants. Gear up for the biggest challenge in the programming world! After all, it's the geek that shall inherit the earth.
			...
			<div id="madbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>MAD</p></div>
                     ...
                     <a data-toggle="modal" href="#rmad" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#pmad" class="btn btn-primary btn-lg">Prizes</a>



						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Are you an android enthusiast? Do you believe that Android is the future of mobile computing? This is the contest that gives your skills a Dias. Participate in MAD (Mobile App Development) and show the world your love for apps or for the cash prizes in store. So unleash your creativity and develop an easy to use android app. Who knows, this could prove a milestone in your app development career.
						</p>
						<p>Contact details:<br>
							Anjali Verma<br>
						</p>
			...
			<div id="mathbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>MATH GENII</p></div>
                     ...
                     <a data-toggle="modal" href="#rmathgn" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#pmathgn" class="btn btn-primary btn-lg">Prizes</a>


						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Does mathematics turn you on? This is the place for you to fruitify your love for numbers and formulae. Here’s Math Genii, a quiz that satiates your prodigious streak and interest in solving problems. So come explore the genius within you and get a chance to win awesome cash prizes. 



						</p>
						<p>Contact details:<br>
							Abhishek gupta(7579087563)<br>Shubham Kansal(7579087579)<br>
...
<a data-toggle="modal" href="#rspl" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#pspl" class="btn btn-primary btn-lg">Prizes</a>


						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Have you the got the creative instinct in you? Here you get a platform to prove your mettle. The poster making competition that tests your artistic streak is here. So let free your imagination, tap your technical skills and bring out the best of you. The event requires making a poster on one of the hot topics of today. Participate and give your calibre in art a chance to win awards for you.
			...
			<div id="techbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<a data-toggle="modal" href="#rttl" class="btn btn-primary btn-lg">Rules</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    <a data-toggle="modal" href="#pttl" class="btn btn-primary btn-lg">Prizes</a>

						<div style="text-align: justify;margin-top:14px;margin-left: 8px;margin-right: 8px;font-size: 13px;">
...
<div class="modal fade" id="pcrux" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          First prize will be Rs 3000 <br>Second Prize will be RS 2000 <br> starting this 20th sept 8pm
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<b>CLICK <a href="rulespdf/envision.docx" target="_blank">HERE</a> FOR PROBLEM STATEMENT</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="penv" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          First prize will be Rs 3000 <br>Second Prize will be RS 2000 <br>for each CS , EC and EE
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
7. Last date of submission is- 27th september,2013.<br>
...
<b>CLICK <a href="rulespdf/problemstat.pdf" target="_blank">HERE</a> FOR PROBLEM STATEMENT</b>
...
<b>CLICK <a href="rulespdf/splash.docx" target="_blank">HERE</a> FOR PROBLEM STATEMENT</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
7. The last date for story submission is 25th September 2013.<br>

8. Final results will be declared on the iFest2013 website by 29th September 2013.<br>
<b>CLICK <a href="rulespdf/techtales.docx" target="_blank">HERE</a> FOR PROBLEM STATEMENT</b>
...
<div class="faqs hidden">
    ...
    <span style="font-family:'Quicksand',sans-serif;margin-left:94px;font-size:19px;">Grab your iFest Tshirts <a href="http://goo.gl/Kq0NDf" target="_blank" style="text-decoration:underline;">Here</a></span>
