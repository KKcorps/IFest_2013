<?php
//uncomment the following to test the backend
...
$dbc = mysqli_query($con,"UPDATE counter SET counter = counter + 1");
...
var a1="Registrations are now open!";
...
var a3="Matrixed is ONN!";



//var a4="PJokovic starts at midnight";
...
<div id="home_wrapper">
<a href="edit_profile.php"><div id="usrnm" style="text-decoration:underline;"><?php if(isset($_SESSION['username'])) echo "Welcome ".$_SESSION['username']; ?></div></a>


		<a href="http://ieeeiitr.com" target="_blank"><img src="ieee_logo.png" style="position:absolute;top:3%;left:12px;height:42px;"></a>

	<a href="http://www.iitr.ac.in" target="_blank"><img src="iitr_logo.png" style="position:absolute;top:12%;left:12px;height:50px;" /></a>

	     <a href="/ifest2013/signup.php" target="_blank">

		<!--<div class="sgn" style="position:absolute;right:0%;top:0%;height:110px;width:13%;z-index:100000;background-color:#76d7af;">

			<span style="color:white;padding-left:30px;font-weight:600;font-size:16px;"><img src="sgn.png" style="margin-top:37px;"></span>
...
<img src="17.png" id="ifesticon4"  width="230" height="230" style="position:absolute;left:600px;top:370px;z-index:800;display:none;"/>
	...
	<a href="ifest.php"><img src="FInal_iFest_Logo.png" id="ifesticon1" width="280" height="280" style="position:absolute;left:450px;top:160px;z-index:1000;display:none;"/>
	...
	<img src="21.png" id="ifesticon6"  width="40" height="40" style="position:absolute;left:710px;top:160px;z-index:901;display:none;"/>
	<span style="font-family: 'Quicksand',sans-serif;position: absolute;width: 100%;left: 40%;top: 450%;color: #FFF;font-weight: bolder;font-size: 19px;">Grab your iFest Tshirts <a href="http://goo.gl/Kq0NDf" target="_blank" style="text-decoration:underline;">Here</a></span>
   ...
   $("#ifestlink").fadeIn(200);
	...
	<div class="colours tk-museo-sans">
		...
		<script>
			...
			//$('.colours').click(function(){ //$('.sgn').css("right","-87px"

				//$('.sgn').delay(500).animate({right:"-87px"},"500");});

			</script>


		<a href="<?php if(isset($_SESSION['username'])) echo '/ifest2013/logout.php';else echo '/ifest2013/signup.php';?>" class="sgn who_we_are" data-current="false" id="ifest_register" onclick="success();"><span data-colour="#76d7af" data-name="who_we_are" class="colour" onclick="success();"><span><?php if(isset($_SESSION['username'])) echo "Logout";else echo "Sign Up";?></span></span></a>
			...
			<div id="cruxbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>CRUX 3.0</p></div>
                                       <div> <a data-toggle="modal" href="#rcrux" class="btn btn-default" style="float:left;">Rules</a>
                    <a data-toggle="modal" href="#pcrux" class="btn btn-default" style="float:right;">Prizes</a></div>

  
						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Let the world know you are out on a quest! A quest for the lost treasure! iFest 2013 brings you all new season of treasure hunting in Crux 3.0. This game is designed to test your creativity, resourcefulness and appetite for winning. Here you have only one golden rule: 'solve the maximum number of puzzles, no matter how'. Remember, everything is fair in love, war and Crux 3.0!



						</p>
						<p>Contact details:<br>
							Kakul Chandra(879147543)<br> Rohan Prasad(8171517273)<br> Abhijeet Gaur(945632823)<br>Chirag Choudhary(8979529483)<br>
			...
			<div id="envibbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>ENVISION</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#renv" class="btn btn-default" style="float:left;">Rules</a>
                    <a data-toggle="modal" href="#penv" class="btn btn-default" style="float:right;">Prizes</a></div>


						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>
						...
						<p>Contact Details:<br>
							Pranay Kumar Choudhary (7409235290) <br> Surendra Kumar Gadwal (8958034190)</p>
			...
			<div id="logibbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>LOGICODE</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rlogi" class="btn btn-default" style="float:left;">Rules</a>
					<a href="http://www.codechef.com/LGCD2013/" target="_blank" class="btn btn-success" style="position:relative;left:14%;">Play</a>	 
                    <a data-toggle="modal" href="#plogi" class="btn btn-default" style="float:right;">Prizes</a></div>


						<div style="text-align: justify;margin-top:38px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Was #include<'meinthisworld'> the first word that came out of your mouth after birth?  Do you prefer counting in binary than in decimal? Do you dream coding? Then, sleep will be on standby as your system will experience the tremors of Logicode when the coding wizards will tear apart mathematical, scientific and technical problems in a furious battle of wits against the best brains across the world. The contest will test the programming skills and problem-solving capabilities of the participants. Gear up for the biggest challenge in the programming world! After all, it's the geek that shall inherit the earth.



						</p>
						<p>Contact details:<br>
							Shubham Kansal(7579087579)<br> Adury Surya Kiran(8909084320)<br>
			...
			<div id="madbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>MAD</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rmad" class="btn btn-default" style="float:left;">Rules</a>
                    <a data-toggle="modal" href="#pmad" class="btn btn-default" style="float:right;">Prizes</a></div>



						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Are you an android enthusiast? Do you believe that Android is the future of mobile computing? This is the contest that gives your skills a Dias. Participate in MAD (Mobile App Development) and show the world your love for apps or for the cash prizes in store. So unleash your creativity and develop an easy to use android app. Who knows, this could prove a milestone in your app development career.
						</p>
						<p>Contact details:<br>
							Anjali Verma<br>
							7500320729
			...
			<div id="mathbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>MATH GENII</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rmathgn" class="btn btn-default" style="float:left;">Rules</a>
\
                    <a data-toggle="modal" href="#pmathgn" class="btn btn-default" style="float:right;">Prizes</a></div>


						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Does mathematics turn you on? This is the place for you to fruitify your love for numbers and formulae. Here’s Math Genii, a quiz that satiates your prodigious streak and interest in solving problems. So come explore the genius within you and get a chance to win awesome cash prizes. 



						</p>
						<p>Contact details:<br>
							Nitish sharma (8439519336)<br>Shubham Kansal(7579087579)<br>
			...
			<div id="matrbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>MATRIXED</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rmtx" class="btn btn-default" style="float:left;">Rules</a>
			<!--<a href="http://ifest.ieeeiitr.com/matrixed2013/main.php" target="_blank" class="btn btn-success" style="position:relative;left:14%;">Play</a> -->
                    <a data-toggle="modal" href="#pmtx" class="btn btn-default" style="float:right;">Prizes</a></div>


						<div style="text-align: justify;margin-top:70px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Unleash the geek in you! iFest 2013 brings out the new season of Matrixed, the destination for all the quizzers across the country. Here, participants are interrogated with multifarious and boundless brain eating questions about any axis of science and technology.  Only a handful of participants make it through the fierce competition, only the superior of the superiors. Warning for the light hearted one: play at your own risk, because it's only the best who survives! 



						</p>
						<p>Contact details:<br>
							Vishu goyal(9761022128)<br>
			...
			<div id="splashbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>SPLASH</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rspl" class="btn btn-default" style="float:left;">Rules</a>
                    <a data-toggle="modal" href="#pspl" class="btn btn-default" style="float:right;">Prizes</a></div>


						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;"><p>Have you the got the creative instinct in you? Here you get a platform to prove your mettle. The poster making competition that tests your artistic streak is here. So let free your imagination, tap your technical skills and bring out the best of you. The event requires making a poster on one of the hot topics of today. Participate and give your calibre in art a chance to win awards for you.



						</p>
						<p>Contact details:<br>
							Suraj Kumar Sau(7417487463)<br>Vikalp Gupta(7409234124)<br>
			...
			<div id="techbbx" style="display:none;height:100%">
				...
				<div style="margin-top: 53px;">
					...
					<div style="text-align: center; font-size: 32px;margin-bottom: 30px;"><p>TECHTALES</p></div>
                                      ...
                                      <div> <a data-toggle="modal" href="#rttl" class="btn btn-default" style="float:left;">Rules</a>
                    <a data-toggle="modal" href="#pttl" class="btn btn-default" style="float:right;">Prizes</a></div>

						<div style="text-align: justify;margin-top:96px;margin-left: 8px;margin-right: 8px;font-size: 13px;">
...
Grab a pen and start writing the most creative story you can imagine. Take up a theme from superhuman, time-travel, space wars, or anything else and let your imagination run wild. Check out the problem statement for further details. 
						...
						<p>Contact details:<br>
							Pranay Kumar Choudhary(7409235290)<br>Surendra Kumar Gadwal(8958034190)
						</p>
	...
	<div id="bkimg" style="position:fixed;background-repeat:no-repeat;height:768px;width:1088.5px;margin-left:-100px;z-index:-10000;" width="1088.5px"height="768px">
</div> <!--bkimg ends-->
<div style="z-index:3;">
  <div class="modal fade" id="rcrux" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          1) The aim of this event is getting ahead to the next level in any way possible.<br>
...
(eg. K9 can be written as "knine" and 2012 as "twozeroonetwo".)<br>
7) Crux will start on <b>21st Sept, 8pm</b>
        </div>
...
<div class="modal fade" id="pcrux" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <p class="modal-title">Prizes</p>

        </div>
        <div class="modal-body">
          First prize will be Rs 3000 <br>Second Prize will be RS 2000 <br> starting this 21th sept 8pm
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="renv" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
references, the idea proposed with figures (if needed) to ifest.envision2013@gmail.com<br>

2. It is necessary to register on the iFest 2013 website to participate in the contest.<br>

3. Regarding the topics which are having subtopics, the participants should prefer the subtopics 

suggested, but can also suggest their own topic which is a sub-field of the parent topic.<br>

4. Abstract should not exceed 350 words and the covering page of the abstract must have 

Name(s), Institution of study, Email address(s), Contact number(s), Name of the field you wish to 

present the paper in and the Topic of paper presentation.<br>

5. Last date for abstract submission is <b>25</b> September 2013.<br>

<b>CLICK <a href="rulespdf/envision.docx" target="_blank"><u>HERE</u></a> FOR PROBLEM STATEMENT</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="penv" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
          First prize will be Rs 2000 <br>Second Prize will be Rs 1000 <br>for each CS , EC and EE
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="rlogi" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
       1. Contest problems will become visible on Tuesday, 27 September 2013 at 18:00 hours IST and contest will end at 27th September 23:59 IST.. Check your time zone <b><u><a href="http://everytimezone.com" target="_blank" style="color:#111;">here</a></b></u>.<br>
	2. This is a not a Team Contest. It is an Individual contest.<br>
	3. This competition will be open globally. Anybody can participate and win prizes. But to claim the prizes, one should register here.  (There will be one  on campus (IIT Roorkee) and one off campus winner.<br>
	4. Almost all languages supported on CodeChef are allowed.<br>
	5. Each program will be tested based on our critical test data. However output and input should be exactly as specified in the samples provided. All white space characters in the output will be ignored.<br>
	6. Please contact kansalshubham46@gmail.com for any queries during the contest.<br>
	<b>7. All participats should register on ifest official website.</b><br>
	8. All participants are expected to abide by the CodeChef Code Of Conduct.<br>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="plogi" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
       First Prize - 2000 INR (Off-campus)<br>
       Second Prize - 1500 INR (Off campus)<br>
       Third Prize - 1000(On campus)<br>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="rmad" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
          1. All Participations can come in the team of three or less.<br>
2. All applications should be based on Android devices based on API 4 – 18.<br>
3. Don't use any previous code. If you get caught, you will be disqualified from the contest.<br>
4. You may take a idea from other sources,any other app idea other than given may be 
considered,given, that idea is confirmed with us.<br>
5. Send the details of your team with your registration usernames, design and features of the 
idea you are working with at- ifest.mad@gmail.com .<br>
6. Prize will be awarded to the team as a whole, not individually.<br>
7. Last date of submission is- 28th september,2013.<br>
8. You can always refer to http://developer.android.com<br>
9. You can surf the web and find many tutorials and their blogs.<br>
Note : Its compulsory for the participants to register on the website first.<br>
<b>CLICK <a href="rulespdf/problemstat.pdf" target="_blank"><u>HERE</u></a> FOR PROBLEM STATEMENT</b>
...
<div class="modal fade" id="pmad" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
       First prize will be Rs 1500 <br>Second Prize will be RS 1000 <br>Third Prize wiil be Rs 500
      </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="rmathgn" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
         1) This is an individual contest.<br>
         2) There will be 5 levels. Next level will be accessible only if atleast 2 questions of the previous level have been succesfully solved.<br>
         3) First Level has 4 questions of 1 mark each, Second Level has 3 questions of 2 marks each, Third Level has 3 questions of 3 marks each, Fourth Level has 3 questions of 5 marks each and Fifth Level has 2 questions of 10 marks each.<br>
...
<div class="modal fade" id="pmathgn" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="rmtx" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
           1) There will be total 3 rounds.<br>
          2) The first round consistes of general aptitute questions with time limit of 1 min each.<br>
          3) each Participant gets to solve 45 questions in first round.<br>
          4) There is no negative points for the wrong answer and 1 point for each correct answer.<br>
          5) First round will last 3 days starting from 25th September 2013. <br>
          6) Top 50 scorers will be taken forward to the second and Third round which will also be held online. <br>
          7) Decision of the organisers will be final .<br>
          8) <b>Do not refresh the page while playing else the question displayed will be counted as attempted.</b><br>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="pmtx" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="rspl" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
         1) Participants must register themselves on iFest 2013 to become eligible for participation. If not registered yet, follow this link to register yourself on iFest.<br>

2) There isn’t any age limit.<br>

3) A participant can send a maximum of 2 entries only.<br>

4) A maximum of two persons can participate as a team.<br>

5) Entries (e-mailed / couriered) must contain the following details.<br>

Full Name of Participant (s) :<br>
...
6) Deadline : 29th September 2013.<br>
<b>CLICK <a href="rulespdf/splash.docx" target="_blank"><u>HERE</u></a> FOR PROBLEM STATEMENT</b>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        </div>
...
<div class="modal fade" id="pspl" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<div class="modal fade" id="rttl" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div class="modal-body">
1. The word limit for each submission is 1200 words.<br>

2. It is necessary to register on the iFest 2013 website to participate in the contest.<br>

3. Send your submissions to ifest.techtales2013@gmail.com<br>

4. A single contestant can send story entries for multiple topics.<br>

5. Any kind of copying would lead to immediate disqualification.<br>

6. Send the entries in “.pdf” format only.<br>

7. The last date for story submission is <b>29 September 2013</b>.<br>

8. Final results will be declared on the iFest2013 website by <b>3 October 2013</b>.<br>
<b>CLICK <a href="rulespdf/techtales.docx" target="_blank"><u>HERE</u></a> FOR PROBLEM STATEMENT</b>
...
<div class="modal fade" id="pttl" tabindex="100" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
      ...
      First prize will be Rs 1500 <br>Second Prize will be RS 1000 <br>Third Prize wiil be Rs 500
		...
		<div class="tiles" width="1088px" height="768px"style="position: fixed;height: 100%;right: 0%;overflow: auto;z-index: 1;width: 28.60%;">



		 <div><img onclick="changeImage('tile1')" class="tile" id="ico1" align="right" width="90px" height="90px"  style="background-image:url('logo/crux.png');position:absolute;top:0%;right:76%;"></div>



	     <div><img onclick="changeImage('tile2')" class="tile" id="ico2" align="right" width="90px" height="90px"  style="background-image:url('logo/envision.png');position:absolute;top:15%;right:76%"></div>



         <div><img onclick="changeImage('tile3')" class="tile" id="ico3" align="right" width="90px" height="90px"  style="background-image:url('logo/logicode.png');position:absolute;right:76%;top:30%;"></div>



         <div><img onclick="changeImage('tile4')" class="tile" id="ico4" align="right" width="90px" height="90px"  style="background-image:url('logo/mad.png');right:76%;position:absolute;top:45%;"></div>



         <div><img onclick="changeImage('tile5')" class="tile" id="ico5" align="right" width="90px" height="90px"  style="background-image:url('logo/mathgenii.png');position:absolute;right:76%;top:60%;"></div>



         <div><img onclick="changeImage('tile6')" class="tile" id="ico6" align="right" width="90px" height="90px"  style="background-image:url('logo/matrix.png');right:76%;position:absolute;top:75%;"></div>



     	 <div><img onclick="changeImage('tile7')" class="tile" id="ico7" align="right" width="90px" height="90px"  style="background-image:url('logo/splash.png');right:76%;position:absolute;top:90%;"></div>



     	 <div><img onclick="changeImage('tile8')" class="tile" id="ico8" align="right" width="90px" height="90px"  style="background-image:url('logo/techtales.png');position:absolute;right:76%;top:105%;"></div>



 		</div>		

			<div style="height:107%;width:21.1%;background-color:rgba(253, 248, 248, 0.4);position:fixed;z-index:1;left:78%;top:0px;"><div id="bbox"style="color:black;font-family: 'Raleway', sans-serif;padding:10px;width:21%;position:fixed;margin-right:10px;">
...
<div>
	...
	<li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url('images/archit1.jpg');">



        <img src="images/archit2.jpg" alt="">
        ...
        <p class="name">
            ...
            <a target="_blank" href="https://www.facebook.com/archit.agrawal2" target="_blank">Archit Agrawal</a>
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/digant1.jpg);">



        <img src="images/digant2.jpg" alt="">
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/gouresh.jpg);">



        <img src="images/gouresh.jpg" alt="">
        ...
        <p class="name">
             ...
             <a target="_blank" href="https://www.facebook.com/">Gouresh Singhal</a>
...
<ul class="the-team greylink">
    ...
    <li class="seattleEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/angad.jpg);">



        <img src="images/angad.jpg" alt="">
    ...
    <li class="seattleEmployee">
        ...
        <p class="name">
            ...
            <a target="_blank" href="https://www.facebook.com/kritgya1">Kritigya Bawal</a>
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/newkid2.png);">
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/palak1.jpg);">



                <img src="images/palak2.jpg" alt="">
   ...
   <li class="seattleEmployee">
        ...
        <a target="_blank" href="https://www.facebook.com/himanshu.tandon27" class="team-thumb" style="background-image:url(images/himanshu1.jpg);">



        <img src="images/himanshu2.jpg" alt="">
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/newkid.png);">
    ...
    <li class="seattleEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/alankrita1.jpg);">



        	<img src="images/alankrita2.jpg" alt="">
    ...
    <li class="londonEmployee">
        ...
        <a class="team-thumb" style="background-image:url(images/divyen.jain.jpg);">
...
<ul>
<li>Amlan Baishya</li>
<li>Kushal Saharan</li>
<li>Yatharth Bhatiya</li>
<li>Parag Nandi</li>
<li>Atul Nayyar</li>
<li>Ajay Shivhare</li>
...
<div class="faqs hidden">
    ...
    <a href="http://esparsha.com/" target="_blank"style="position:absolute;left:7%;top:126%;"><img src="img/esparsha.png" alt="Esparsha" style="width:200px;"><p>Merchandise Partner</p></a>



    <a href="http://www.virscent.com/" target="_blank"style="position:absolute;left:26%;top:191%;"><img src="img/Virscent.png" alt="Virscent" style="width:200px;"><p>Ethical Hacking Workshop Partner</p></a>



    <a href="http://www.reverttech.com/" target="_blank"style="position:absolute;left:26%;top:340%;"><img src="img/reverttech.png" alt="Revert Technology" style="width:200px;"><p>Robotics Partner</p></a>



    <a href="http://www.finlandlabs.com/" target="_blank"style="position:absolute;left:7%;top:429%;"><img src="img/finland_logo.png" alt="Finlandlabs" style="width:200px;"><p>Android Partner</p></a>



    <a href="http://www.orpinetechnologies.com/" target="_blank"style="position:absolute;left:48%;top:208%;"><img src="img/Graphic1.png" alt="Orphinetechnologies" style="width:333px;"><p>Workshop Partner</p></a>



	<a href="https://www.freecharge.in/" target="_blank"style="position:absolute;left:48%;top:418%;"><img src="img/freecharge.jpg" alt="FreeCharge" style="width:200px;"><p>Event partner</p></a>



<a href="http://www.markmyfest.com/" target="_blank"style="position:absolute;left:76%;top:191%;"><img src="img/MMF.png" alt="markmyfest" style="width:200px;"><p>Marketing partner</p></a>

<!--left 7 top 496-->

<a href="http://www.twenty19.com/" target="_blank"style="position:absolute;left:76%;top:443%;"><img src="img/Twenty19.png" alt="Twenty19" style="width:200px;"><p>Student Internship Partner</p></a>

<!-- left 26 top 500-->	

<a href="http://www.magnivatech.com/" target="_blank"style="position:absolute;left:7%;top:600%;"><img src="img/magniva.jpg" alt="Magniva" style="width:242px;"><p>Technology Partner</p></a>
<a href="http://www.cafecoffeeday.com/" target="_blank"style="position:absolute;left:33%;top:550%;"><img src="img/ccdbig.png" alt="CafeCoffeeDay" style="width:175px;"><p>Beverage partner</p></a>	
...
<dl>
 ...
 <dt><h4>Archit Agrawal - Convener(Admin)</h4>
