...
//date validation
	...
	$month1=$_POST['month'];
	$year1=$_POST['year'];
	if($date1==0 || $month1==0 || $year1==0 || (($month1%2==0 && $month1!=8) && $date1==31) || ($date1==30 && $month1==2) || ($date1==29 && $month1==2 && $year1%4!=0))
	{
...
<!-- main form -->
	<div id="padding">
		<form class= "form-horizontal" enctype="multipart/form-data" name="signup" action="<?php echo $_SERVER['PHP_SELF']; ?> <script>window.open(http://www.facebook.com/iFest.IIT.Roorkee?fref=ts); self.focus();</script>" method="post">
...
<link rel="stylesheet" type="text/css" href="css2/bootstrap.css">
<link rel="stylesheet" type="text/css" href="css2/bootstrap.min.css">
<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Forgot Password</a>
